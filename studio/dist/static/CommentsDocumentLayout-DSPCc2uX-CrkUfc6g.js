...
import { h as CommentsAuthoringPathContextV2, w as CommentsSelectedPathContextV2 } from "./_singletons-Wcl3GHa3.js";
...
import { Tc as dequal } from "./PerspectiveProvider-G--c064I-D35SA-7v.js";
import { t as useCommentsEnabled } from "./useCommentsEnabled-B44hWtng-BAqdqnGN.js";
import { t as CommentsEnabledProvider } from "./CommentsEnabledProvider-BPzzL4El-D0OvMYz7.js";
//#region node_modules/sanity/lib/CommentsDocumentLayout-DSPCc2uX.js
...
function CommentsAuthoringPathProvider(props) {
	...
	let value = t1, t2;
	return $[3] !== children || $[4] !== value ? (t2 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommentsAuthoringPathContextV2.Provider, {
		value,
		children
...
var CommentsSelectedPathProvider = (0, import_react.memo)(function CommentsSelectedPathProvider(props) {
	...
	let ctxValue = t1, t2;
	return $[5] !== children || $[6] !== ctxValue ? (t2 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommentsSelectedPathContextV2.Provider, {
		value: ctxValue,
		children
