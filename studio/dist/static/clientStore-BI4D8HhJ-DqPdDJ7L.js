const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["static/stegaEncodeSourceMap-Dj29aWKG-Deo3KVbY.js","static/stegaClean-YZRATV86-Bt6b4A1r.js","static/resolveEditInfo-Cz-smq3a-1440fgSt.js","static/isRecord-Kfmt-nk--QjzbOyHQ.js","static/browserUpload-BTQyjHMj-BT7VPaBw.js","static/Observable-dfeu5CEH.js","static/request-CYLhJzOA-CrhuoUwD.js"])))=>i.map(i=>d[i]);
import { n as __exportAll$1 } from "./rolldown-runtime-DC62tzP2.js";
import { C as __spreadArray, S as __read, a as SafeSubscriber, b as __extends, d as Subscription, f as arrRemove, m as isFunction, p as createErrorClass, r as identity, t as Observable } from "./Observable-dfeu5CEH.js";
import { _ as isArrayLike, a as defineRequester, f as anySignal, g as innerFrom, h as executeSchedule, i as _defineProperty, l as isQueryParseError, n as CorsOriginError, o as formatQueryParseError, p as from, x as operate, y as createOperatorSubscriber } from "./request-CYLhJzOA-CrhuoUwD.js";
import { t as Subject } from "./Subject-Bs90HcI7.js";
import { t as isRecord } from "./isRecord-Kfmt-nk--QjzbOyHQ.js";
import { t as stegaClean } from "./stegaClean-YZRATV86-Bt6b4A1r.js";
import { a as getVersionFromId, i as getPublishedId, l as isVersionId, o as getVersionId, r as getDraftId, s as isDraftId } from "./resolveEditInfo-Cz-smq3a-1440fgSt.js";
...
function _fetch$2(client, httpRequest, _stega, query, _params = {}, options = {}) {
	...
	return stega.enabled ? Promise.all([request, __vitePreload(() => import("./stegaEncodeSourceMap-Dj29aWKG-Deo3KVbY.js").then((n) => n.n), __vite__mapDeps([0,1,2,3]))]).then(([res, { stegaEncodeSourceMap }]) => {
...
function _upload(client, _httpRequest, assetType, body, opts = {}) {
	...
	return typeof XMLHttpRequest < "u" ? defer(async () => {
		let { uploadWithProgress } = await __vitePreload(async () => {
			const { uploadWithProgress } = await import("./browserUpload-BTQyjHMj-BT7VPaBw.js");
			return { uploadWithProgress };
		}, __vite__mapDeps([4,5,6,3])), req = _prepareRequest(client, { ...baseRequest });
		return uploadWithProgress({
...
//#endregion
//#region node_modules/@sanity/sdk/dist/createStateSourceAction-DdAhEfnZ.js
/**
* @beta
*/
...
//#endregion
//#region node_modules/@sanity/sdk/dist/object-CxXlSVg7.js
/**
...
//#endregion
//#region node_modules/@sanity/sdk/dist/clientStore-BI4D8HhJ.js
var clientStore_BI4D8HhJ_exports = /* @__PURE__ */ __exportAll$1({
	A: () => __exportAll,
	C: () => isStudioConfig,
	D: () => getAuthLogger,
	E: () => REQUEST_TAG_PREFIX,
	T: () => DEFAULT_BASE,
	a: () => authStore_exports,
	b: () => getTokenFromLocation,
	c: () => getDashboardOrganizationId,
	d: () => getTokenState,
	f: () => setAuthToken,
	h: () => getCleanedUrl,
	i: () => authStore,
	k: () => createLogger,
	l: () => getIsInDashboardState,
	m: () => getAuthCode,
	n: () => getClient,
	o: () => getAuthState,
	p: () => createLoggedInAuthState,
	r: () => getClientState,
	s: () => getCurrentUserState,
	t: () => clientStore_exports,
	u: () => getLoginUrlState,
	w: () => DEFAULT_API_VERSION$1,
...
function isLoggingEnabled() {
	return typeof process < "u" && true ? globalConfig.enableInProduction : !0;
}
/**
...
var authStore = defineStore({
	...
	getInitialState(instance) {
		...
		let { apiHost: configApiHost, callbackUrl, providers: customProviders, token: providedToken, clientFactory = createClient, initialLocationHref = getDefaultLocation() } = instance.config.auth ?? {}, apiHost = configApiHost ?? void 0, authConfig = instance.config.auth ?? {}, loginDomain = "https://www.sanity.io";
		try {
...
var getClient = bindActionGlobally(clientStore, ({ state, instance }, options) => {
	...
	let apiHost = options.apiHost ?? instance.config.auth?.apiHost ?? void 0, effectiveOptions = {
...
//#endregion
export { concatAll as $, isDatasetResource as A, skip as B, bindActionByResourceAndPerspective as C, defineStore as D, createStateSourceAction as E, DisconnectError as F, distinctUntilChanged as G, share as H, createClient as I, merge as J, catchError as K, tap as L, isReleasePerspective as M, ChannelError as N, getEnv as O, ConnectionFailedError as P, concat as Q, takeWhile as R, bindActionByResource as S, createActionBinder as T, finalize as U, shareReplay as V, exhaustMap as W, fromEvent as X, timer as Y, defer as Z, getDefaultLocation as _, ReplaySubject as _t, authStore as a, isValidDate as at, isDeepEqual as b, createLogger as c, isObservable as ct, getAuthState as d, popResultSelector as dt, mergeAll as et, getCleanedUrl as f, popScheduler as ft, getDashboardOrganizationId as g, AsyncAction as gt, getCurrentUserState as h, AsyncScheduler as ht, __exportAll as i, map as it, isMediaLibraryResource as j, isCanvasResource as k, getAuthCode as l, throwError as lt, getClientState as m, asyncScheduler as mt, DEFAULT_BASE as n, mergeInternals as nt, clientStore_BI4D8HhJ_exports as o, lastValueFrom as ot, getClient as p, EMPTY as pt, filter as q, REQUEST_TAG_PREFIX as r, mapOneOrManyArgs as rt, createLoggedInAuthState as s, EmptyError as st, DEFAULT_API_VERSION$1 as t, mergeMap as tt, getAuthLogger as u, of as ut, getTokenFromLocation as v, dateTimestampProvider as vt, bindActionGlobally as w, omitProperty as x, getTokenState as y, switchMap as z };
